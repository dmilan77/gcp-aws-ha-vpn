module "vpn_ha" {
  ...
  peer_external_gateway = {
    ...
    interfaces = [{
      id         = 0
      ip_address = "34.239.70.107" # aws router ip address
      },
      {
        id         = 1
        ip_address = "52.70.218.248" # aws router ip address
      },
      {
        id         = 2
        ip_address = "34.204.237.59" # aws router ip address
        }, {
        id         = 3
        ip_address = "52.45.83.0" # aws router ip address
    }, ]
  }
